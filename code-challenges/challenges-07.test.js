...
const howMuchPencil = (str) => {
  ...
  {
    // slice string array and store as new array
    let newStringArray = stringArray.slice(i, 7);
    // convert new array back to string
    let newString = newStringArray.join('');
    // push new array (stringified) into result
...
const listFoods = (recipe) => {
  ...
  // store ingredient as array of words
  ingredient = ingredient.split(' '); 
  // slice ingredient array at 2, to ignore first two words
  ingredient = ingredient.slice(2);
  //make array string again
  ingredient = ingredient.join(' ');
  // add ingredient to result array
