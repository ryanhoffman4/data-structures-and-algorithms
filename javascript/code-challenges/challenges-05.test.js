...
const addPurchases = (arr) => {
  // Solution code here...
  let total = arr.reduce((currentTotal, item) => {
    currentTotal = currentTotal + item.purchasePrice;
    return currentTotal;
  }, 0)
  return total;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let names = arr.reduce((nameList, person) => {
...
const reversedString = (str) => {
  ...
  let reverse = newArray.reduce((newString, char) => {
